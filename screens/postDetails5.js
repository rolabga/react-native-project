...
const [show, setShow] = React.useState(false);
  ...
  return (
    <View style={{backgroundColor: 'white', flex:1}}>
        ...
        <Text style={styles.Tagline}>Discover England</Text>
        <Text style={styles.Placename}>Explore the scenic beauty of England</Text>
        ...
        <TouchableOpacity style={styles.BookTicketbtn} onPress={goView6}>
