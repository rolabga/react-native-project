...
const Favorite = ({}) => {
  ...
  return (
    <ImageBackground source={require('../assets/menu1.jpg')} style={styles.background}> 
        <View style={styles.DarkOverlay}></View>
    <View style={{Height: '100%', maxHeight: screenHeight}}>
        <View style={styles.LightOverlay}></View>
        <Feather size={30} name="star" color="#fff" style={{top:72, left:25}}/>
        <Text style={{fontSize:30, fontWeight: 'bold', top:35,left:60, color: '#fff'}}>Favorites</Text>
        <ScrollView contentContainerStyle={{ flexGrow: 2 }} style={{top:35}}>
        <View style={{marginTop: -20}}>
                <Image
                    source={require('../assets/Costa1.jpg')}
                ...
                <View style={{position: 'absolute', padding: 16, bottom: 28}}>
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <Text style={{top:95, left: 12, fontSize: 22, color: 'white', fontWeight:'normal', bottom: 6}} >Costa Rica</Text>
                    </View>
                    ...
                    Costa Rica is known for its zip-lining tours, whitewater rafting, kayaking, scuba diving, cliff diving, and sky diving, among other adrenaline-pumping activities. 
                    </Text>
                </View>
            </View>
            ...
            <View>
                <Image
                    source={require('../assets/Machu2.jpg')}
                ...
                <View style={{position: 'absolute', padding: 16, bottom: 28}}>
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <Text style={{top:110, left: 12, fontSize: 22, color: 'white', fontWeight:'normal', bottom: 6}} >Machu Picchu</Text>
                    </View>
                    ...
                    Machu Picchu, site of ancient Inca ruins located about 50 miles from Cuzco, Peru, in the Cordillera de Vilcabamba of the Andes Mountains.
                    </Text>
                </View>
            </View>
            ...
            <View>
                <Image
                    source={require('../assets/Phuket3.jpg')}
                ...
                <View style={{position: 'absolute', padding: 16, bottom: 28}}>
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <Text style={{top:135, left: 12, fontSize: 22, color: 'white', fontWeight:'normal', bottom: 6}} >Phuket</Text>
                    </View>
