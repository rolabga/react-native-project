    ...
    return (
        <View style={{backgroundColor: 'white', flex:1}}>
            ...
            >
                ...
                <View style={{top:125}}>
                     <Text style={styles.text}>1-2 Days |        320 kms</Text>
                ...
                <Text style={styles.text2}>out of 5 (6452 Reviews)</Text>
            ...
            <View style={styles.LightOverlay}></View>
                <View style={{bottom: 60, right: 180}}>    
                    <Text style={styles.textTitle}>Acropolis of Athens, Greece</Text>
                </View>

                <View style={{bottom: 90, right: 195}}>    
                    <Text style={styles.textBody}>The Acropolis of Athens is an ancient citadel located on a rocky outcrop above the city of Athens and contains the remains of several ancient buildings of great architectural and historic significance, the most famous being the Parthenon. The Acropolis of Athens is an ancient citadel located on a rocky outcrop above the city of Athens and contains the remains of several ancient buildings of great architectural and historic significance, the most famous being the Parthenon.</Text>
                </View>
                ...
                <Text style={styles.textBody4}>A mythical home of the gods</Text>
                <Text style={styles.textBody5}>March to May and</Text>
        </View>
    )
}
