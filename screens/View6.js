...
const View6 = ({navigation}) => {
    ...
    return (
        <View style={{backgroundColor: 'white', flex:1}}>
            <ImageBackground
              source={require('../assets/England.jpeg')}
              style={{width: '130%', height: '100%', justifyContent: 'flex-end',right: 170}}
              imageStyle={{resizeMode: 'stretch'}}
            >
                <View style={styles.DarkOverlay}></View>
                <View style={{top:120}}>
                     <Text style={styles.text}>2-3 Days |        320 kms</Text>
                ...
                <Text style={styles.text2}>out of 5 (3521 Reviews)</Text>
            ...
            <View style={styles.LightOverlay}></View>
                <View style={{bottom: 60, right: 180}}>    
                    <Text style={styles.textTitle}>Stonehenge, England</Text>
                </View>

                <View style={{bottom: 90, right: 195}}>    
                    <Text style={styles.textBody}>Stonehenge is a prehistoric monument in Wiltshire, England, two miles (3 km) west of Amesbury. It consists of a ring of standing stones, each around 13 feet (4.0 m) high, seven feet (2.1 m) wide, and weighing around 25 tons. The stones are set within earthworks in the middle of the most dense complex of Neolithic and Bronze Age monuments in England, including several hundred tumuli (burial mounds).</Text>
                </View>

                <View>
                <TouchableOpacity onPress={goReserve} style={{backgroundColor: 'white', height: 50, right: 5, bottom:270, width: 420,borderTopRightRadius:30,borderTopLeftRadius:30}}>
                    <Text style={{color:'black', fontSize: 22, fontWeight: 'bold', textAlign: 'center',top:10}}>Reserve Now!</Text>
                </TouchableOpacity>
                </View>

                <Text style={styles.textBody1}>Known as:  </Text>
                <Text style={styles.textBody2}>Best Time to Visit:    </Text>
                <Text style={styles.textBody4}>Most famous Neolithic Monuments</Text>
                <Text style={styles.textBody5}>June to September</Text>
        </View>
    )
}
