    ...
    return (
        <View style={{backgroundColor: 'white', flex:1}}>
            ...
            >
                ...
                <View style={{top:125}}>
                     <Text style={styles.text}>1-2 Days |        470 kms</Text>
                ...
                <View style={{top:15, left: 10}}>
                  ...
                  <Text style={styles.text2}>out of 5 (2124 Reviews)</Text>
            ...
            <View style={styles.LightOverlay}>
                ...
                <View style={{bottom: 60, right: 180}}>    
                    <Text style={styles.textTitle}>Eiffel Tower, Paris</Text>
                </View>

                <View style={{bottom: 90, right: 195}}>    
                    <Text style={styles.textBody}>For 130 years, the Eiffel Tower has been a powerful and distinctive symbol of the city of Paris, and by extension, of France. At first, when it was built for the 1889 World's Fair, it impressed the entire world by its stature and daring design, and symbolized French know-how and industrial genius. It was the main exhibit of the Paris Exposition — or World's Fair — of 1889. It was constructed to commemorate the centennial of the French Revolution and to demonstrate France's industrial prowess to the world.</Text>
                </View>
                ...
                <Text style={styles.textBody3}>September to October</Text>
                <Text style={styles.textBody4}>La Tour Eiffel</Text>
                <Text style={styles.textBody5}>June to August and</Text>
            </View>
