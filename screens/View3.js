    ...
    return (
        <View style={{backgroundColor: 'white', flex:1}}>
            ...
            >
                ...
                <View style={{top:130}}>
                     <Text style={styles.text}>2 Days |          500 kms</Text>
                ...
                <Text style={styles.text2}>out of 5 (4651 Reviews)</Text>
            ...
            <View style={styles.LightOverlay}></View>
                <View style={{bottom: 60, right: 180}}>    
                    <Text style={styles.textTitle}>Las Vegas, Nevada</Text>
                </View>

                <View style={{bottom: 90, right: 195}}>    
                    <Text style={styles.textBody}>Las Vegas (Spanish for "The Meadows"), officially the City of Las Vegas and often known simply as Vegas, is the 28th-most populated city in the United States, the most populated city in the state of Nevada, and the county seat of Clark County. The city anchors the Las Vegas Valley metropolitan area and is the largest city within the greater Mojave Desert. Las Vegas is an internationally renowned major resort city, known primarily for its gambling, shopping, fine dining, entertainment, and nightlife.</Text>
                </View>
                ...
                <Text style={styles.textBody4}>Entertainment and Nighlife</Text>
